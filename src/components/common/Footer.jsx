        ...
        <div className="container">
          <div className="row">
            ...
            <div className="footer-col">
              ...
              <ul>
                <li>
                  <a href="mailto:vashu4842@gmail.com?body=fell free to type">
                    Gmail
                  </a>
                </li>
                <li>
                  <a href="tel:6396665246">Helpline No</a>
                </li>
              </ul>
            </div>
            <div className="footer-col">
              ...
              <div className="social-links">
                <a
                  href="https://www.linkedin.com/in/nowitsvashu/"
                  target="blank"
                >
                  <FaLinkedin className=" mx-auto mt-3 scale-125" />
                </a>
                <a href="https://twitter.com/nowitsvashu" target="blank">
                  <FaTwitter className=" mx-auto mt-3 scale-125" />
                </a>

                <a href="https://www.instagram.com/nowitsvashu/" target="blank">
